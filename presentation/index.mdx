...
drag. You never want to do anything with it.
...
<Notes>
  Have a dynamic layout that I can easily change and adjust as necessary. Also
  have the core feed which gives me actionable components based on things that
  happen during the flight. Since it's just components, and they all load data
  from the unified Apollo GraphQL cache, it's really easy to do.
</Notes>
