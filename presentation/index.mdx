...
<img src={require("../assets/hypercard.png")} style={{ height: "20vh" }} />

---

<img src={require("../assets/vic.jpg")} style={{ height: "70vh" }} />
...
```GraphQL
 extend type Mutation {
    """
    Action: Simulator: Change Simulator Layout
    """
    changeSimulatorLayout(simulatorId: ID!, layout: String!): String


    """
    Action: Simulator: Change Alert Level
    """
...
<ul style={{ textAlign: "left" }}>
  ...
  <li style={{ fontSize: "1px" }}>
    React renderer for computer controlled lighting
  </li>
